...
publication, independent of the invoking process's umask. A lock-free reader
that observes the marker/document mismatch possible during the first migration
