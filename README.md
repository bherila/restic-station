...
- **Cloud placeholder safety** — cloud-backed sources skip online-only files instead of hydrating them, and cloud-synced repositories are refused while any repository file is dataless.
