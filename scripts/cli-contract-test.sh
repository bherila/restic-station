...
cloud_repository_not_hydrated|no|1|unit:needs an SF_DATALESS File Provider placeholder, which no shell fixture can create (the walk is pinned in CloudStorageSafetyTests)
